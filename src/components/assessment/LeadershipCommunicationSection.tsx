...
import { leadershipCommunicationCompetencies } from '../../constants/roleCompetencies/leadershipCommunication';
import type { RoleLevel } from '../../types/assessment.types';

interface LeadershipCommunicationSectionProps {
  roleLevel: RoleLevel;
  ratings: Record<string, number>;
  onRatingChange: (criterionId: string, value: number) => void;
}

export const LeadershipCommunicationSection: React.FC<LeadershipCommunicationSectionProps> = ({
  roleLevel,
  ratings,
  onRatingChange,
}) => {
  const competencyData = leadershipCommunicationCompetencies[roleLevel];
...
export default LeadershipCommunicationSection;