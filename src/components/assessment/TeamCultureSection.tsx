...
import { teamCultureCompetencies } from '../../constants/roleCompetencies/teamCulture';
...
export const TeamCultureSection: React.FC<TeamCultureSectionProps> = ({
  roleLevel,
  ratings,
  onRatingChange,
}) => {
  const competencyData = teamCultureCompetencies[roleLevel];
