...
import { independenceGrowthCompetencies } from '../../constants/roleCompetencies/independenceGrowth';
import type { RoleLevel } from '../../types/assessment.types';

interface IndependenceGrowthSectionProps {
  roleLevel: RoleLevel;
  ratings: Record<string, number>;
  onRatingChange: (criterionId: string, value: number) => void;
}

export const IndependenceGrowthSection: React.FC<IndependenceGrowthSectionProps> = ({
  roleLevel,
  ratings,
  onRatingChange,
}) => {
  const competencyData = independenceGrowthCompetencies[roleLevel];
...
export default IndependenceGrowthSection;